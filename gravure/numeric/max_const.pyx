...
cdef :
    ...
    uint32  MAX_UINT32  = 4294967295U

IF HAVE_INT64:
    cdef :
        int64   MAX_INT64   = 9223372036854775807L
        int64   MIN_INT64   = - MAX_INT64 - 1L
IF HAVE_UINT64:
    cdef :
        uint64  MAX_UINT64  = 18446744073709551615UL

IF HAVE_INT128:
    cdef :
        int128  MAX_INT128  = 85070591730234615865843651857942052864LL
        int128  MIN_INT128  = - MAX_INT128 - 1LL

IF HAVE_UINT128:
    cdef :
        uint128 MAX_UINT128 = 170141183460469231731687303715884105728ULL
