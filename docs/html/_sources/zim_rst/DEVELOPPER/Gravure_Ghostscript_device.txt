...
| bases	→  gdevprn.c, gdevprn.h, gdevbit.c, *doc for* `gs_device <http://svn.ghostscript.com/ghostscript/tags/ghostscript-9.02/doc/Drivers.htm>`_
...
| GHOSTSCRIPT CUTTING'S EDGE → `here <http://svn.ghostscript.com/ghostscript/>`_
| `http://www.ghostscript.com/pipermail/gs-devel/ <http://www.ghostscript.com/pipermail/gs-devel/>`_
